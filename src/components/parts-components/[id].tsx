...
// ─── Column definitions (same as PartsList) ───────────────────────────────────
...
// ─── Retailer configs ─────────────────────────────────────────────────────────
const RETAILER_META: Record<string, { color: string; bg: string }> = {
    ...
    return (
        <div style={{
            ...
            <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "2rem", flexWrap: "wrap" }}>
                        ...
                        <div style={{
                            ...
                            <button
                                ...
                                style={{
                                    padding: "0.7rem 2rem",
                                    background: added ? "rgba(15,217,128,0.15)" : T.green,
                                    color: added ? T.green : "#000",
                                    border: added ? `1px solid ${T.green}` : "none",
                                    borderRadius: 8,
                                    fontSize: "0.9rem",
                                    fontWeight: 700,
                                    cursor: "pointer",
                ...
                {/* ── Two-column layout: Specs + Price & Retailer ── */}
                <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "1.5rem", alignItems: "start" }}>

                    {/* LEFT: Full Specifications */}
                    <div style={{
                    ...
                    {/* RIGHT: Price Breakdown + Where to Buy */}
                        ...
                        <div style={{
                            ...
                            <div style={{ padding: "1rem 1.5rem" }}>
                                ...
                                <a
                                    ...
                                    onMouseEnter={e => {
                                        (e.currentTarget as HTMLAnchorElement).style.background = T.greenGlow;
                                        (e.currentTarget as HTMLAnchorElement).style.borderColor = T.green;
                                    }}
                                    onMouseLeave={e => {
                                        (e.currentTarget as HTMLAnchorElement).style.background = T.greenDim;
                                        (e.currentTarget as HTMLAnchorElement).style.borderColor = `${T.green}44`;
                                    }}
                                >
                                    View on {part.where} →
                                </a>
